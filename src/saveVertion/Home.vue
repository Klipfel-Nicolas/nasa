...
export default {
    ...
    methods: {
        ...
        init: function() {
            ...
            this.scene.background = textureLoader.load("/textures/spaceTexture1.jpeg");   /*new THREE.Color('black')*/
            ...
            gltfLoader.setPath( './3DObjects/mars-perseverance-rover/source/' ).load( 'Perseverance.glb', ( object ) => {
                ...
                modelFolder.add(this.rover.position, 'x', -3, 3, .3).name('lateral')
                modelFolder.add(this.rover.position, 'y', -3, 3, .3).name('y')
                modelFolder.add(this.rover.position, 'z', -5, 5, .03).name('far')
                modelFolder.add(this.rover.rotation, 'y', -3, 3, .03).name('rotation')
                modelFolder.add(this.rover.rotation, 'x', -3, 3, .03).name('rotation')
