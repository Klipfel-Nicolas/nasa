    ...
    <div id="perseverance">
        ...
        <div class="htmlContainer index">
            ...
            <div class="left-column">
                ...
                >
                    <div v-if="currentElement" >          
                        <div class="infos">
                            ...
                            <p 
                                v-html="currentElement.more" 
                                class="longDescription backgoundOpaq"
                            ></p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Image left corner -->
                <div class="imageLeft">
                    <img src="/images/drawPerseverance.png" alt="rover perseverance">
                </div>
            </div>
        ...
        <!-- THREE -->
        <perseverence-three
            :elementsPerseverance="elements"
            :listDisplay="listDisplay"
            :currentElement="currentElement"
            :oldCurrentElement="oldCurrentElement"
            :wireframe="wireframe"
            @elementChange="onListClick($event)"
        />
    </div>
</template>
...
import PerseverenceThree from '../components/three/PerseverenceThree.vue';
    ...
    methods: {
        ...
        onListClick(element){   
            ...
            if(this.currentElement && element.name === this.currentElement.name){
                this.oldCurrentElement = this.currentElement;
                this.currentElement = null;
            }else{
