<template>
    <div @dblclick="fullScreen" class="home" id="home">
...
export default {
    ...
    methods: {
        ...
        init: function() {
            ...
            // Iss
            gltfLoader.setPath( './3DObjects/iss/' ).load( 'scene.gltf', ( object ) => {
                this.iss = object.scene
                this.iss.scale.multiplyScalar(.3);
                this.scene.add( this.iss );
                this.iss.position.set(-15, 3, 18)
                
                gui.add(this.iss.position, 'x', -15, 15, .1).name('issX')
                gui.add(this.iss.position, 'y', -15, 15, .1).name('issY')
                gui.add(this.iss.position, 'z', -15, 15, .1).name('issZ')
            })
        ...
        animate: function(){
           ...
           if(this.iss){
              this.iss.position.set( ( Math.sin( elapsed/15 )) * 4, 8, (Math.cos( elapsed/15)) * 4 );
            }
